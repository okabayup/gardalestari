...
export const MemberCard = ({ name, username, position, avatarUrl, titlePrefix, titlePostfix }: MemberCardProps) => {
  ...
  const cardContent = (
    <div className="text-center transition-all duration-300 group">
      <div
      ...
      <div className="mt-3">
        <p className={cn("font-semibold leading-tight break-words text-sm", username && "group-hover:text-primary")}>{fullName}</p>
