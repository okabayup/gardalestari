...
export default function EditDataBankEntryPage() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="font-headline text-2xl font-bold">Edit Entri Bank Data</h1></div>
      ...
      <Card>
        <CardHeader><CardTitle>Detail Entri</CardTitle></CardHeader>
