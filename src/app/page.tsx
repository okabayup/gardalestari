...
export default async function LandingPage() {
  ...
  const initiatives = [
    { title: 'Kampung Aren', desc: 'Inovasi pengolahan aren desa untuk ekonomi lokal.', img: '/program/Kampung%20Aren.jpg', category: 'Komunitas' },
    { title: 'Sedekahpohon.org', desc: 'Gerakan digital penanaman pohon untuk reboisasi massal.', img: '/program/Sedekah%20Pohon.jpg', category: 'Reboisasi' },
    { title: 'Vanili Lestari', desc: 'Pertanian vanili berkelanjutan dengan standar kualitas global.', img: '/program/Vanili%20Lestari.jpg', category: 'Pertanian' },
  ...
  const partners = [
    ...
    { name: 'KKP', url: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhVlnwerlS3bGvBZeB4BNCQnl1bHvwBAkKO3NY2yf0isvrN2egSPM_VT7rkEV3lJBYXaFmJvprDlU5Xr2kZTK564YnUhX_SWuPmRYiaDoYItCcFhhnBrf3QcdJ-qNn31JV5Zfgaoz7fWIViBz6KwvnGp39roEqCWOI6m8lbuBtSzYe9RHFq-8WAVA/s320/Kementerian%20Kelautan%20dan%20Perikanan%20(KKP)%20Republik%20Indonesia.png' },
          ...
          <div className="container px-6 space-y-8 md:space-y-12">
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-4 text-center md:text-left">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-[10px] md:text-xs font-bold uppercase tracking-widest">
                  <Newspaper size={14} /> Kabar Terbaru
                </div>
                <h2 className="text-3xl md:text-4xl font-black tracking-tighter text-accent">Aksi yang Berdampak</h2>
              </div>
              <Button asChild variant="ghost" className="font-bold hover:text-primary">
                <Link href="/berita">Semua Berita <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </div>
            
            <NewsCarousel posts={spotlightPosts} />
          </div>
        </section>
